...
подставьте любой рабочий инстанс — поле **URL Piped** в настройках плагина.

> **Важно:** YouTube периодически блокирует публичные инстансы Piped для получения
> данных о видео (`/streams`) — ошибка *"Sign in to confirm you're not a bot"*.
> Плагий отрисовывает страницу видео из данных карточки и не блокируется при этом:
> похожие видео, описание и комментарии могут быть недоступны, но **воспроизведение
> через cobalt работает независимо от Piped**.
